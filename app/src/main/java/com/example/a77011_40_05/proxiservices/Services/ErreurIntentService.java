package android.com.exemplegooglecoudmessaging2.Services;

import android.app.IntentService;
import android.com.exemplegooglecoudmessaging2.Entities.Erreur;
import android.com.exemplegooglecoudmessaging2.Shares.Constants;
...
public class ErreurIntentService extends IntentService {
    ...
    private static final String ACTION_ERREUR = "android.com.exemplegooglecoudmessaging2.Services.action.FOO";
    private static final String EXTRA_ERREUR = "android.com.exemplegooglecoudmessaging2.Services.extra.PARAM1";
        ...
        try {
            if (intent != null) {
                ...
                if (ACTION_ERREUR.equals(action)) {
                    ...
                    String url = Constants.URL_SW + "addErreur.php";
