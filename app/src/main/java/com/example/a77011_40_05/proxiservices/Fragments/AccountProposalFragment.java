...
public class AccountProposalFragment extends Fragment {

    public AccountProposalFragment() {
        // Required empty public constructor
    }



    public static AccountProposalFragment newInstance() {
        AccountProposalFragment fragment = new AccountProposalFragment();
